...
clientkeys = gears.table.join(clientkeys,
    ...
    {description = "Volume way up", group = "launcher"}),
    ...
    {description = "Volume way down", group = "launcher"}),
    ...
    {description = "Light Up", group = "launcher"}),
    
    awful.key({modkey, "Shift"}, "Up",
    function ()
        awful.spawn.with_shell("xbacklight -inc 5")
    end,
    {description = "Light way Up", group = "launcher"}),
    ...
    {description = "Light Down", group = "launcher"}),

    awful.key({modkey, "Shift" }, "Down",
    function ()
        awful.spawn.with_shell("xbacklight -dec 5")
    end,
    {description = "Light way Down", group = "launcher"})
)
...
awful.key({"modKey", }, "Up",
    ...
    {description = "Light up by 1"}),

awful.key({"modKey",}, "Down",
    function()
        awful.spawn.with_shell("xbacklight -dec 1")
    end,
    {description = "Light down by 1"}),]]
