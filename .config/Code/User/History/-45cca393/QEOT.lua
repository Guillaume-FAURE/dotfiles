...
local batteryWidgetIcon = batteryWidget{
    ac = "AC",
    adapter = "BAT0",
    ac_prefix = "AC: ",
    battery_prefix = "Bat: ",
...
globalkeys = gears.table.join(
    ...
    function ()
        awful.spawn.with_shell("pamixer -i 1")
    end,
    ...
    {description = "Volume way up", group = "Volume"}),


    awful.key({"Control"  }, "Down",
    function ()
        awful.spawn.with_shell("pamixer -d 1")
    end,
    ...
    {description = "Volume way down", group = "Volume"}),

    awful.key({modkey  }, "Up",
    function ()
        awful.spawn.with_shell("xbacklight -inc 1")
    end,
    {description = "Light Up", group = "Light"}),
    
    awful.key({modkey, "Shift"}, "Up",
    function ()
        awful.spawn.with_shell("xbacklight -inc 5")
    end,
    {description = "Light way Up", group = "Light"}),
    ...
    {description = "Light Down", group = "Light"}),

    awful.key({modkey, "Shift" }, "Down",
    function ()
        awful.spawn.with_shell("xbacklight -dec 5")
    end,
    {description = "Light way Down", group = "Light"}),
    ...
    awful.key({ modkey, "Shift" }, "Down",
        function (c) c:relative_move(  0,  20,   0,   0) end, { description="resize down", group="resizer"}),
    awful.key({ modkey, "Shift"   }, "Up", 
    function (c) c:relative_move(  0, -20,   0,   0) end,{ description="resize down", group="resizer"}),
    awful.key({ modkey, "Shift"   }, "Left",
    function (c) c:relative_move(-20,   0,   0,   0) end, { description="resize down", group="resizer"}),
