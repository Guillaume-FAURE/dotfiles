...
For the macro to work, we have to abandonned the idea of a recursive function as a macro or to make the preprocessor go multiple time through macro as a normal processor but it 